...
export default function Hero() {
  ...
  return (
    <div className="font-sans min-h-screen bg-[#FFFFFF]">
      {/* ── Top Nav ── */}
      <header className="bg-[#FFFFFF] shadow-sm sticky top-0 z-50 border-b border-[#2C9DD5]">
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-2">
            <a href="/" className="flex items-center gap-1">
              <span className="text-white font-bold text-xl tracking-tight leading-none">
                property
                <span className="text-[#E87C02]">Brands</span>
              </span>
            </a>
          ...
          <div className="flex items-center gap-3">
            <button className="text-white text-sm font-medium hover:text-[#E87C02] transition hidden sm:block">
              PB Prime
            </button>
            <button className="text-white text-sm font-medium hover:text-[#E87C02] transition">
              Login
            </button>
            <button className="bg-[#BA0D0B] text-[#15191C] text-sm font-bold px-4 py-1.5 rounded hover:bg-[#5C0B03] transition flex items-center gap-1.5 shadow">
              Post Property
              <span className="bg-[#E87C02] text-[#FFFFFF] text-[10px] font-bold px-1.5 py-0.5 rounded">FREE</span>
            </button>
          </div>
        </div>

        {/* ── Secondary Nav ── */}
        <nav className="bg-[#FFFFFF] border-b border-[#E5E8EB] shadow-sm">
            ...
            <ul className="flex items-center gap-0 overflow-x-auto scrollbar-hide">
              {NAV_LINKS.map((link) => (
                <li key={link.label}>
                  <a
                    href="#"
                    className="flex items-center gap-1 px-4 py-3 text-sm font-medium text-[#1F242A] hover:text-[#2C9DD5] whitespace-nowrap transition border-b-2 border-transparent hover:border-[#2C9DD5]"
                  >
                    {link.label}
                    {link.badge && (
                      <span className="bg-[#E87C02] text-white text-[9px] font-bold px-1 py-0.5 rounded ml-0.5 leading-none">
                        {link.badge}
                      </span>
                    )}
                    {link.hasDropdown && (
                      <svg className="w-3 h-3 text-[#5B6670]" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd" />
                      </svg>
                    )}
                  </a>

        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="flex-1 min-w-0">
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-[#1F2937] mb-1 leading-tight">
                ...
                {content.headlineHighlight && (
                  <span className="text-[#1565C0] font-extrabold">{content.headlineHighlight}</span>
                )}{" "}
                  ...
                  <button
                    ...
                    className={`px-4 py-2.5 text-sm font-semibold transition-all whitespace-nowrap border-b-2 -mb-px ${
                      currentTab === tab
                        ...
                        : "text-[#6B7280] border-transparent hover:text-[#1565C0]"
                    }`}
                  >
                    {tab}
                  </button>
              ...
              <div className="flex flex-col sm:flex-row gap-0 border border-[#E2E8F0] rounded-lg overflow-visible shadow-sm bg-[#FFFFFF]">
                ...
                <div className="flex items-center gap-2 px-3 py-3 flex-1 min-w-0 border-b sm:border-b-0 sm:border-r border-[#E2E8F0]">
                  <svg className="w-4 h-4 text-[#1565C0] shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div className="absolute top-full left-0 mt-1 w-48 bg-[#FFFFFF] border border-[#E2E8F0] rounded-lg shadow-xl z-50 py-1">
                      {PROPERTY_TYPES.map((type) => (
                        <button
                          ...
                          className="block w-full text-left px-4 py-2 text-sm text-[#1F2937] hover:bg-[#EFF6FF] hover:text-[#1565C0] transition"
                        >
                          {type}
                        </button>
                      ))}
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 bg-[#1565C0] text-white px-6 py-3 text-sm font-bold hover:bg-[#0D47A1] transition rounded-b-lg sm:rounded-b-none sm:rounded-r-lg whitespace-nowrap"
                >
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  {QUICK_CTAS.map((cta, i) => (
                    <button
                      ...
                      className="text-xs border border-[#E2E8F0] text-[#6B7280] px-3 py-1.5 rounded-full hover:border-[#1565C0] hover:text-[#1565C0] transition font-medium"
                    >
                      {cta.label}
                    </button>
                  ))}
                  ...
                  <div className="p-4">
                    ...
                    {content.promoCtaLabel && (
                      <button
                        ...
                        className="w-full bg-[#1565C0] text-white text-xs font-bold py-2 rounded hover:bg-[#0D47A1] transition"
                      >
                        {content.promoCtaLabel}
                      </button>
                    )}
                    <div className="flex justify-center gap-1.5 mt-3">
                      {[0, 1, 2].map((i) => (
                        <span key={i} className={`block w-1.5 h-1.5 rounded-full ${i === 1 ? "bg-[#1565C0]" : "bg-[#E2E8F0]"}`} />
                      ))}
                    </div>
                  </div>
                </div>
          ...
          {cards.length > 0 && (
            <div className="mt-10">
              ...
              <div className="w-12 h-0.5 bg-[#1565C0] mb-5 rounded-full" />

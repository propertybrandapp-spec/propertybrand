...
const PARTNER_BANKS = [
  { name: "SBI", abbr: "SBI", rate: "8.50%", color: "bg-[#0F2D52]", textColor: "text-white" },
  { name: "HDFC Bank", abbr: "HDFC", rate: "8.70%", color: "bg-sky-600", textColor: "text-white" },
  { name: "ICICI Bank", abbr: "ICICI", rate: "8.75%", color: "bg-[#F59E0B]", textColor: "text-white" },
  ...
  { name: "Kotak Bank", abbr: "KMB", rate: "8.85%", color: "bg-[#F59E0B]", textColor: "text-white" },
];
          ...
          <div className="flex flex-col items-center">
            <div className="relative w-32 h-32 mb-3">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                ...
                <p className="text-sm font-extrabold text-[#1F2937]">{fmt(emi)}</p>
              </div>
            </div>
    ...
    <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-lg">
      <div className="bg-[radial-gradient(circle_at_top_right,_rgba(30,136,229,0.12),_transparent_35%),linear-gradient(to_right,#ffffff,#f8fafc)] border-b border-slate-200 px-6 py-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-[#1F2937] font-bold text-lg">Loan Eligibility Check</h3>
  ...
  return (
    <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-lg">
      <div className="bg-[radial-gradient(circle_at_top_right,_rgba(74,222,128,0.12),_transparent_35%),linear-gradient(to_right,#ffffff,#f8fafc)] border-b border-slate-200 px-6 py-6">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-[#F0FDF4] border border-[#4ade80]/20 flex items-center justify-center">
            <svg className="w-5 h-5 text-[#4ade80]" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
            </svg>
          </div>
          <div>
            <h3 className="text-[#1F2937] font-bold text-lg">ROI Calculator</h3>
      ...
      <div className="p-6 md:p-8 grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-2 flex flex-col justify-center">
          {[
            ...
            <div key={row.label} className="flex items-center justify-between py-2.5 border-b border-[#E2E8F0] last:border-0">
              <span className="text-xs text-slate-500">{row.label}</span>
              <span className={`text-sm ${row.bold ? "font-extrabold text-[#4ade80]" : "font-semibold text-[#1F2937]"}`}>{row.value}</span>
            </div>
          ))}
          <p className="text-[11px] leading-relaxed pt-2" style={{ color: "#6B7280" }}>
    ...
    <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-lg">
      <div className="bg-[radial-gradient(circle_at_top_right,_rgba(167,139,250,0.12),_transparent_35%),linear-gradient(to_right,#ffffff,#f8fafc)] border-b border-slate-200 px-6 py-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-[#1F2937] font-bold text-lg">Rental Yield Calculator</h3>
      ...
      <div className="p-6 md:p-8 grid md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col justify-center gap-4">
          <div className="rounded-2xl p-6 text-center" style={{ background: "#F0EAFB" }}>
            <p className="text-xs font-semibold" style={{ color: "#6B7280" }}>Gross Rental Yield</p>
            <p className="text-3xl font-extrabold mt-1" style={{ color: "#a78bfa" }}>{grossYield.toFixed(2)}%</p>
            <p className="text-xs mt-1" style={{ color: "#6B7280" }}>{fmt(annualRent)} / year</p>
          </div>
          <p className="text-[11px] leading-relaxed" style={{ color: "#6B7280" }}>
            Bhubaneswar properties typically yield 3–6.5% gross. This estimate excludes maintenance, taxes, and vacancy periods.
          </p>
        </div>
      </div>
    </div>
...
function CorridorCard({ corridor }) {
  return (
    <div className="flex-shrink-0 w-64 bg-[#FFFFFF] rounded-xl border border-[#E2E8F0] overflow-hidden hover:shadow-lg transition-shadow duration-200 cursor-pointer group">
      ...
      <div className="p-3.5 grid grid-cols-3 gap-2">
        ...
        <div className="text-center">
          <p className="text-[11px] font-bold text-[#1F2937] leading-tight">{corridor.priceRange}</p>
      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
            {INVESTMENT_TOOLS.map((tool) => (
              ...
              >
                ...
                <div>
                  <p className="text-sm font-bold text-[#1F2937]">{tool.label}</p>
          ...
          <div id="high-growth-corridors" style={{ ...sectionHighlight("high-growth-corridors"), scrollMarginTop: "100px" }} className="mb-10 p-4 -m-4">
            <h3 className="text-base font-bold mb-1" style={{ color: "#1F2937" }}>High-Growth Investment Corridors</h3>
            <p className="text-sm mb-4" style={{ color: "#6B7280" }}>Areas identified by our analysts for strong price appreciation potential.</p>
          ...
          <div id="rental-yield-opportunities" style={{ ...sectionHighlight("rental-yield-opportunities"), scrollMarginTop: "100px" }} className="mb-10 p-4 -m-4">
            <h3 className="text-base font-bold mb-1" style={{ color: "#1F2937" }}>Best Rental Yield Opportunities</h3>
            <p className="text-sm mb-4" style={{ color: "#6B7280" }}>Areas ranked by rental income relative to purchase price — ideal for buy-to-let investors.</p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {yieldSorted.map((c, i) => (
                <div key={c.id} className="rounded-xl p-4 flex items-center gap-3" style={{ background: "#F8FAFC", border: "1px solid #E2E8F0" }}>
          ...
          <div id="commercial-investments" style={{ ...sectionHighlight("commercial-investments"), scrollMarginTop: "100px" }} className="mb-10 p-4 -m-4">
            <h3 className="text-base font-bold mb-1" style={{ color: "#1F2937" }}>Commercial Investments</h3>
            <p className="text-sm mb-4" style={{ color: "#6B7280" }}>Office and retail spaces typically offer higher rental yields and longer-term corporate tenants than residential property.</p>
            <div className="flex gap-4 overflow-x-auto pb-2" style={{ scrollbarWidth: "none" }}>
          ...
          <div id="land-banking" style={{ ...sectionHighlight("land-banking"), scrollMarginTop: "100px" }} className="mb-10 p-4 -m-4">
            <h3 className="text-base font-bold mb-1" style={{ color: "#1F2937" }}>Land Banking Opportunities</h3>
            <p className="text-sm mb-4" style={{ color: "#6B7280" }}>Buy undeveloped or under-developed plots in the path of growth and hold for long-term appreciation.</p>
            <div className="flex gap-4 overflow-x-auto pb-2" style={{ scrollbarWidth: "none" }}>
          ...
          <div id="retirement-homes" style={{ ...sectionHighlight("retirement-homes"), scrollMarginTop: "100px" }} className="mb-10 p-4 -m-4">
            <h3 className="text-base font-bold mb-1" style={{ color: "#1F2937" }}>Retirement Homes</h3>
            <p className="text-sm mb-4" style={{ color: "#6B7280" }}>Purpose-built senior living communities with medical access, single-level layouts, and a built-in social community.</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {RETIREMENT_HOMES.map((home) => (
                <div key={home.name} className="rounded-xl overflow-hidden" style={{ border: "1px solid #E2E8F0" }}>

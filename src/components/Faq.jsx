    ...
    <div style={{ background: "#FFFFFF" }}>
      ...
      <section className="px-4 pb-16">
        <div className="max-w-3xl mx-auto space-y-3">
          {filtered.map((item, i) => (
            <div key={item.q} className="rounded-2xl overflow-hidden" style={{ border: "1px solid #E5E8EB" }}>
              <button
              ...
              >
                ...
                <svg
                  ...
                  style={{ color: "#2C9DD5", transform: openIndex === i ? "rotate(180deg)" : "rotate(0deg)" }}
              ...
              {openIndex === i && (
                <div className="px-5 pb-5 text-sm leading-relaxed" style={{ color: "#495057", background: "#FFFFFF" }}>
                  {item.a}
                </div>
              )}
            </div>
